...
npm test             # 236 unit tests over the physics, terrain and coordinate math
npm run test:ui      # 28 browser tests: builds dist/, drives it in Chromium
