...
npm test             # 226 unit tests over the physics, terrain and coordinate math
npm run test:ui      # 23 browser tests: builds dist/, drives it in Chromium
