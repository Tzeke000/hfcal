...
npm test             # 228 unit tests over the physics, terrain and coordinate math
npm run test:ui      # 25 browser tests: builds dist/, drives it in Chromium
