...
npm test             # 221 unit tests over the physics, terrain and coordinate math
npm run test:ui      # 19 browser tests: builds dist/, drives it in Chromium
