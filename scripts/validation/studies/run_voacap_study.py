...
Compares the app's takeoff-angle and hop-count model (src/physics/propagation.js)
...
# App model constants — must mirror src/physics/propagation.js (HOP.F2)
...
# maxHopKm() in src/physics/propagation.js; see run_layer_study.py.
