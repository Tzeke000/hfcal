#!/usr/bin/env python3
"""VOACAP validation of the frequency advisor's MUF model (src/physics/freqAdvisor.js).
...
# angle (magneticLatitude() in src/physics/magnetic.js). The paths run due east and are
