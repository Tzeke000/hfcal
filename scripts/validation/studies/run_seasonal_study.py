...
--eval to skip VOACAP and just score src/physics/freqAdvisor.js against the data
...
# (magneticLatitude() in src/physics/magnetic.js). The ionosphere is organised by the
